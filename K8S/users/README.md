...
```
aws s3 sync s3://kops-state-b429b/kubernetes.amitvashist7/pki/private/ca/ ca-key
aws s3 sync s3://kops-state-b429b/kubernetes.amitvashist7/pki/issued/ca/ ca-crt
